...
<OPTIONS Product="Arposh New User Creation" Version="1.2">
 ...
 <Default>
  ...
  <MsSFU30NisDomain>internal</MsSFU30NisDomain>
 </Default>
 <Locations>
  <Location Site="NY">
...
function Call-ANUC_pff {
	...
	$labelGid = New-Object System.Windows.Forms.Label
	$txtMsSFU30NisDomain = New-Object System.Windows.Forms.TextBox
	$labelMsSFU30NisDomain = New-Object System.Windows.Forms.Label
	...
	$formMain_Load={
        ...
        $txtMsSFU30NisDomain.Text = $XML.Options.Default.MsSFU30NisDomain
		
		Write-Verbose "Creating CSV Headers"
		$Headers = @('ID','Domain','Path','FirstName','LastName','Office','Title','Description','Department','Company','Phone','StreetAddress','City','State','PostalCode','Password','sAMAccountName','userPrincipalName','DisplayName', 'UnixUid', 'UnixGid', 'NisDomain')
	...
	$btnSubmit_Click={
        ...
        if ($ADerror) {
            ...
            Set-ADUser $sAMAccountName -Replace @{msSFU30NisDomain = "$MsSFU30NisDomain"}
            Set-ADUser $sAMAccountName -Replace @{uidNumber = "$UnixUid"}
            Set-ADUser $sAMAccountName -Replace @{gidNumber = "$UnixGid"}
	...
	$CSVTemplate_FileOk=[System.ComponentModel.CancelEventHandler]{
		"" |
		Select Domain,Path,FirstName,LastName,Office,Title,Description,Department,Company,Phone,StreetAddress,City,State,PostalCode,Password,sAMAccountName,userPrincipalName,DisplayName,UnixUid,UnixGid,NisDomain |
	...
	$lvCSV_SelectedIndexChanged={
        ...
        try{$txtUid.Text = $lvCSV.SelectedItems[0].SubItems[19].Text}catch [system.exception] {"caught a system exception"}
        try{$txtGid.Text = $lvCSV.SelectedItems[0].SubItems[20].Text}catch{}
        try{$txtMsSFU30NisDomain.Text = $lvCSV.SelectedItems[0].SubItems[21].Text}catch{}
	}
    ...
    $formMain.Controls.Add($txtUid)
	$formMain.Controls.Add($labelUid)
	$formMain.Controls.Add($txtGid)
	$formMain.Controls.Add($labelGid)
	$formMain.Controls.Add($txtMsSFU30NisDomain)
	$formMain.Controls.Add($labelMsSFU30NisDomain)
	...
	$formMain.Text = "AD User Creation"
	...
	# txtUid
	#
	$txtUid.Anchor = 'Top, Left, Right'
	$txtUid.Location = '118, 600'
	$txtUid.Name = "txtUid"
	$txtUid.Size = '173, 20'
	$txtUid.TabIndex = 42
	#
	# labelUid
	#
	$labelUID.Location = '10, 600'
	$labelUID.Name = "labelUID"
	$labelUID.Size = '100, 23'
	$labelUID.TabIndex = 43
	$labelUID.Text = "Unix UserID"
	#
	# labelGid
	#
	$labelGid.Location = '10, 635'
	$labelGid.Name = "labelUID"
	$labelGid.Size = '100, 23'
	$labelGid.TabIndex = 44
	$labelGid.Text = "Unix Group ID"
	$labelUID.TextAlign = 'MiddleLeft'
	#
	# txtGid
	#
	$txtGid.Anchor = 'Top, Left, Right'
	$txtGid.Location = '118, 630'
	$txtGid.Name = "txtUid"
	$txtGid.Size = '173, 20'
	$txtGid.TabIndex = 45
	#
	# labelMsSFU30NisDomain
	#
	$labelMsSFU30NisDomain.Location = '10, 660'
	$labelMsSFU30NisDomain.Name = "labelUID"
	$labelMsSFU30NisDomain.Size = '100, 23'
	$labelMsSFU30NisDomain.TabIndex = 44
	$labelMsSFU30NisDomain.Text = "NisDomain"
	$labelMsSFU30NisDomain.TextAlign = 'MiddleLeft'
	#
	# txtMsSFU30NisDomain
	#
	$txtMsSFU30NisDomain.Anchor = 'Top, Left, Right'
	$txtMsSFU30NisDomain.Location = '118, 660'
	$txtMsSFU30NisDomain.Name = "txtUid"
	$txtMsSFU30NisDomain.Size = '173, 20'
	$txtMsSFU30NisDomain.TabIndex = 45
	#
	# cboDomain
	#
